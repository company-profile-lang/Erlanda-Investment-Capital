...
import logo from '../assets/profile.jpg'; // Uncomment jika punya logo
    ...
    <Navbar bg="light" expand="lg" className="shadow-sm">
      <Container>
        <Navbar.Brand as={NavLink} to="/">
          <img src={logo} width="30" height="30" className="d-inline-block align-top rounded-circle me-2" alt="Logo" />
